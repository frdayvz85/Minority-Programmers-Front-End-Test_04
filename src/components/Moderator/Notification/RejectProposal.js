...
const RejectProposal = (props) => {
    return (<div className="elect--proposal__wrapper voted--revoted">
        <div className="proposal--task">
            <div className="proposal__title--task">
                ...
                <div className="rejected--status">
                       <FaTimesCircle className="pink fa--times" />
                       <span>Rejected</span>
                    </div>
            </div>
            ...
            <div className="proposal--text__more elect--proposal__text--more">
                ...
                <div className="proposal--btns__view--elect">
                    <button className="btn view__proposal--btn__reject">View Proposal</button>
                </div>
            </div>
        </div>
    </div>
